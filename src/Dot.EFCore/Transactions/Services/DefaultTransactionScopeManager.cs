...
namespace Cofoundry.Core.Transactions.Internal
{
    /// <summary>
    /// <para>
    ...
    public class DefaultTransactionScopeManager : IDefaultTransactionScopeManager
    {
        ...
        public ITransactionScope Create(DbConnection dbConnection, Func<TransactionScope> transactionScopeFactory)
        {
            ...
            var primaryScope = _primaryTransactionScopes.TryGetValue(connectionHash, out var value) 
                ? value 
                : default;
        ...
        {
            var connectionHash = dbConnection.GetHashCode();
            var scope = _primaryTransactionScopes.TryGetValue(connectionHash, out var value)
               ? value
               : default;
