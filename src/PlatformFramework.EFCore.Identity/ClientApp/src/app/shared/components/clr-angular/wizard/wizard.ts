...
import {
    AfterContentInit, Component, ContentChildren, DoCheck, ElementRef, EventEmitter, Inject, Input,
    IterableDiffers, OnDestroy, Output, PLATFORM_ID, QueryList, ViewChild
} from "@angular/core";
