 ...
 */
import {
    AfterContentChecked, AfterViewInit, Directive, EmbeddedViewRef, EventEmitter, Inject, Input,
    OnDestroy, Renderer2, TemplateRef, ViewContainerRef
} from "@angular/core";
...
export class ClrPopoverContent implements AfterContentChecked, AfterViewInit, OnDestroy {
