namespace Cofoundry.Core.BackgroundTasks
{
    ...
    public interface IBackgroundTaskScheduler
    {
        ...
        IBackgroundTaskScheduler RegisterAsyncRecurringTask<TTask>(int days, int atHour = 0, int atMinute = 0) 
            where TTask : IAsyncBackgroundTask;
        ...
        /// <returns>Instance of IBackgroundTaskScheduler for method chaining</returns>
        IBackgroundTaskScheduler RegisterAsyncRecurringTask<TTask>(int hours = 0, int minute = 0) 
            where TTask : IAsyncBackgroundTask;
        ...
        /// <returns>Instance of IBackgroundTaskScheduler for method chaining</returns>
        IBackgroundTaskScheduler RegisterAsyncRecurringTask<TTask>(int minutes) 
            where TTask : IAsyncBackgroundTask;
        ...
        /// <typeparam name="TTask">The type of task to execute</typeparam>
        /// <returns>Instance of IBackgroundTaskScheduler for method chaining</returns>
        IBackgroundTaskScheduler DeregisterAsyncRecurringTask<TTask>() 
            where TTask : IAsyncBackgroundTask;
    }
}
